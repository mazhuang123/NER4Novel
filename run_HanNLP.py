...
class hanlp(object):
    def __init__(self, analyzer = "Perceptron", custom_dict = True ):
        ## 数据集目录
        data_path = "E:\work\python3_7Install\Lib\site-packages\pyhanlp\static\data\model\perceptron\large\cws.bin"
        ...
        # self.PLAnalyzer = _PLAnalyzer(data_path, HanLP.Config.PerceptronPOSModelPath, HanLP.Config.PerceptronNERModelPath)
